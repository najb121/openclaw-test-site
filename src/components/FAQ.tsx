...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-20 md:py-32 relative bg-slate-100 dark:bg-slate-900/50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {faqKeys.map((key, index) => (
            <div
              key={key}
              className="rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 overflow-hidden shadow-sm dark:shadow-none"
            >
              <button
              ...
              >
                <div className="px-6 text-slate-600 dark:text-gray-400 leading-relaxed">
